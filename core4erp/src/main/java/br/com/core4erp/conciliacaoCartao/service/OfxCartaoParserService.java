...
@Service
public class OfxCartaoParserService {
    ...
    public OfxDadosDto parse(MultipartFile arquivo) throws IOException {
        ...
        if (!conteudo.contains("<CREDITCARDMSGSRSV1>")) {
            throw new IllegalArgumentException(
                    "Arquivo OFX não é de cartão de crédito. Use a conciliação bancária para arquivos de conta corrente.");
        }
