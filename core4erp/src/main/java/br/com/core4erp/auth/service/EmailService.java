...
public class EmailService {
    ...
    @Async
    public void enviarConvite(String para, String token, String frontendUrl, String nomeEmpresa) {
        ...
        String html = """
                      ...
                      <table width="520" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                          <td style="padding:40px;">
                            ...
                            <p style="font-size:14px;color:rgba(250,250,250,.55);line-height:1.7;margin:0 0 28px;">
                              Você recebeu um convite para ingressar na empresa
                              <strong style="color:#fafafa;">%s</strong> no Core 4 ERP.
                              Clique no botão abaixo para criar sua conta. O convite é válido por
                              <strong style="color:#fafafa;">48 horas</strong>.
                            </p>
                            <div style="text-align:center;margin-bottom:28px;">
                              <a href="%s"
                                 style="display:inline-block;padding:14px 32px;background:#6EFFC0;color:#003824;
                ...
                """.formatted(nomeEmpresa, link, link);
        ...
        try {
            ...
            helper.setFrom(mailFrom);
            helper.setTo(para);
            helper.setSubject("Core 4 ERP — Convite para " + nomeEmpresa);
            helper.setText(html, true);
            mailSender.send(msg);
            log.info("E-mail de convite enviado para {}", para);
        } catch (MessagingException e) {
            log.error("Falha ao enviar e-mail de convite para {}: {}", para, e.getMessage());
        }
    }
}
