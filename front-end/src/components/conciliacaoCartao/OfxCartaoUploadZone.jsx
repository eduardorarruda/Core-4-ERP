    ...
    >
      ...
      {arquivo ? (
        ...
        <>
          ...
          <div className="text-center">
            <p className="font-bold text-text-primary">Arraste o arquivo OFX do cartão aqui</p>
            <p className="text-sm text-text-primary/50">Apenas arquivos de extrato de cartão de crédito (máx. 5 MB)</p>
          </div>
        </>
      )}
