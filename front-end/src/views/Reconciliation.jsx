    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="flex justify-between items-end mb-10">
        <div>
          <nav className="flex items-center gap-2 text-[10px] font-bold text-primary mb-2 uppercase tracking-tighter">
            ...
            <span className="text-zinc-500">/ CONCILIAÇÃO BANCÁRIA</span>
          </nav>
          <h2 className="text-4xl font-bold tracking-tight text-white">Conciliação de Fluxo</h2>
        </div>
        <div className="flex gap-4">
          <button className="px-6 py-2.5 bg-surface-medium text-white text-[10px] font-bold uppercase tracking-widest rounded-xl hover:bg-surface-highest transition-all flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 relative">
        ...
        <section className="space-y-6">
          ...
          <div className="group relative p-8 border-2 border-dashed border-white/10 rounded-2xl bg-surface-low hover:bg-surface-medium transition-all flex flex-col items-center justify-center gap-4 cursor-pointer">
            ...
            <div className="text-center">
              <p className="text-white font-semibold">Arraste seu arquivo OFX ou CSV</p>
              <p className="text-zinc-500 text-sm mt-1">ou clique para selecionar do computador</p>
            </div>
            <button className="mt-2 px-4 py-1.5 bg-surface-highest text-white text-[10px] font-bold rounded-lg uppercase tracking-wider">Select File</button>
          </div>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={i} className={cn(
                ...
                item.suggested ? "border-primary/40 shadow-lg shadow-primary/5" : "border-transparent hover:border-white/10"
              )}>
        ...
        <section className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            <button className="p-1.5 rounded-lg bg-surface-medium text-zinc-400 hover:text-white">
          ...
          <div className="flex gap-3">
            ...
            <select className="bg-surface-low border-none rounded-xl text-[10px] font-bold text-zinc-400 focus:ring-0 px-4 outline-none">
          ...
          <div className="space-y-3">
            <div className="p-4 rounded-xl bg-primary/10 border border-primary/30 flex items-center justify-between transition-all">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-white text-sm font-medium">Venda #4429 — Cliente: Solar Inc.</p>
                </div>
              </div>
              <span className="text-white font-bold">R$ 2.400,00</span>
            </div>
            ...
            <div className="group p-5 rounded-xl bg-surface-medium border-2 border-primary/40 ring-4 ring-primary/5 transition-all">
              <div className="flex justify-between items-start mb-1">
                ...
                <span className="text-white font-bold text-lg">R$ 1.250,00</span>
              </div>
              <p className="text-white font-medium">Contas a Pagar: NF-e 88291</p>
              <p className="text-[10px] text-zinc-500 mt-1 uppercase font-bold">Fornecedor: Tech Flow Solutions Ltda.</p>
            </div>

            <div className="group p-5 rounded-xl bg-surface-medium border border-transparent hover:border-white/10 transition-all">
              <div className="flex justify-between items-start mb-1">
                <span className="text-[10px] font-bold text-zinc-500 uppercase">16 OUT 2023</span>
                <span className="text-white font-bold text-lg">R$ 8.900,00</span>
              </div>
              <p className="text-white font-medium">Recebimento: Lote de Vendas PDV</p>
              <p className="text-[10px] text-zinc-500 mt-1 uppercase font-bold">Origem: Gateway de Pagamentos</p>
            </div>
          </div>
        </section>
      </div>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-4 gap-6">
        {[
          ...
          <div key={i} className="bg-surface-low p-6 rounded-2xl border border-white/5 flex flex-col justify-between">
            <div>
